...
def generate_pdf_report(data, filename):
    try:
        ...
        title = [["          Le                                " + f"Rapport vulnerability @ThiNTA {datetime.today()} "]]
...
def analyze_logs():
    ...
    if data:
        ...
        if vulnerabilities:
            ...
            generate_pdf_report(data, f"rapport_vulnerabilites_ThiNTA.pdf")
        ...
        def merge_pdfs(input_pdfs, output_pdf):
            ...
            try:
                ...
                #print(f'Merged PDFs successfully. Output saved to: {output_pdf} on {datetime.today()}')
            except Exception as e:
        ...
        output_pdf = f'last_report_ThiNTA {datetime.today()}.pdf'
...
# Widgets
tk.Label(root, text="Fichier de Log (TXT) :").grid(row=0, column=0, padx=5, pady=5, sticky="e")
